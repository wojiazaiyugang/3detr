...
--checkpoint_dir outputs/scan_tooth/34 \
--batchsize_per_gpu 8 \
...
--meta_data_dir /media/3TB/data/xiaoliutech/scan_tooth_det_3detr_20230228+20230229+20230230+20230411+20230519_with_axis_and_kps
